...
void Skills(){
    ...
    MoveEncoderPID(Test, 30, 25, 0.3, -90, 1);
    Clamp.set(true);
    wait(500, msec);
    ...
    wait(750, msec);
    RunLift(-100);
    MoveEncoderPID(Test, 70, 3.7, 0.2, 90, 0); // move back from wall steak
    ...
    wait(750, msec);
    RunLift(-100);
    MoveEncoderPID(Test, 70, 4.5, 0.2, -90, 0); // move back from wall steak
    ...
    MoveEncoderPID(Test, -60, 14, 0.2, -60, 0); // get ring
    ...
    wait(400, msec);
    Doinker.set(true);
    MoveEncoderPID(Test, 70, 4, 0.2, 70, 0); // pick up ring
    ...
    TurnMaxTimePID(Test, 42, 1, 0);//turn to climb
    RunLift(100); // run wall stakes mech
    wait(400, msec);
    RunLift(-100);
    RunLift(0);
